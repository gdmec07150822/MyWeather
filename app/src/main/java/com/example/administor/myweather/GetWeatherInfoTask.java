package com.example.administor.myweather;
...
/**
 * Created by admin on 12/25 0025.
 */
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>> {
    ...
    private static String key="&key=7b0b63ca297d5cc9e5e72e2ac28095cc";
    ...
    protected void onPostExecute(List<Map<String, Object>> result) {
        ...
        if (result.size()>0){
            ...
            SimpleAdapter simpleAdapter=new SimpleAdapter(context,result,
                    R.layout.weather_item,new String[]{"temperature","weather","date","week","weather_icon"},
            ...
            if (response.getStatusLine().getStatusCode()==200){
                ...
                if (jsondata.getInt("resultcode")==200){
                    ...
                    for (int i=0;i<7;i++){
                        ...
                        item.put("wind",weatObject.get("wind"));
                    ...
                    errorMsg="非常抱歉，本应用暂不支持您所请求的城市！1";
                }
            }else{
